...
capaz de segmentar este objeto. Aplique o Crescimento de Regiões de forma iterativa, em que o algoritmo irá
estabilizar apenas quando a região parar de crescer. Este tópico diferencia-se do Tópico 23 por ser
necessário encontrar uma regra que utilize os canais R, G e B simultanemante.
'''
import cv2
import numpy as np
