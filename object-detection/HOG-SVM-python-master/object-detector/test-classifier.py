...
if __name__ == "__main__":
    ...
    # Read the image
    im = imread('C:/Users/Solon/Pictures/HOG-SVM-python-master/HOG-SVM-python-master/dataset/test/test-15.pgm', as_grey=True)
    # min_wdw_sz = (100, 40)
    # step_size = (10, 10)
        ...
        for (x, y, im_window) in sliding_window(im_scaled, min_wdw_sz, step_size):
            ...
            if visualize_det:
                ...
                cv2.rectangle(clone, (x, y), (x + im_window.shape[1], y +
                    im_window.shape[0]), (255, 0, 255), thickness=2)
