...
if __name__ == "__main__":
    ...
    pos_feat_path = 'C:/Users/Solon/Pictures/HOG-SVM-python-master/HOG-SVM-python-master/dataset/pos'
    neg_feat_path = 'C:/Users/Solon/Pictures/HOG-SVM-python-master/HOG-SVM-python-master/dataset/neg'
    ...
    for im_path in glob.glob(os.path.join(pos_feat_path, "*")):
        print(im_path)
    ...
    for im_path in glob.glob(os.path.join(neg_feat_path, "*")):
